estimaIdadeAposentadoriaRPPS = function (DadosServidores){
  ...
  idadeMinimaMulherTempoIdade=55     # Idade mÃ?nima para aposentadoria por idade e tempo de contribuiÃ§Ã£o (feminina).
  idadeMinimaHomemTempoIdade=60      # Idade mÃ?nima para aposentadoria por idade e tempo de contribuiÃ§Ã£o (masculina).
  ...
  idadeMinMulherProf=50              # Idade mÃ?nima para uma professora se aposentar.
  idadeMinHomemProf=55               # Idade mÃ?nima para um professor se aposentar.
  ...
  MaiorIdadeRPPSIdadeMulher = 50     # Maior idade que uma mulpode comeÃ§ar a contribuir com RPPS para se aposentar por idade
  MaiorIdadeRPPSIdadeHomem = 55      # Maior idade que uma mulher pode comeÃ§ar a contribuir com RPPS para se aposentar por idade
  MenorIdadeContribuicaoTempo = 25   # Menor idade de contribuiÃ§Ã£o para aposentadoria por tempo idade
